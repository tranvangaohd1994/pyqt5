...
primary_coordinates = 21.002213429248698,105.84612115545423  # Change to your Lat/Lon
...
radar1 = {
    ...
    'zoom': 15,  # this is a google maps zoom factor, bigger = smaller area
